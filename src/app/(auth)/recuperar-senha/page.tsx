    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      <div className="lg:w-2/5 bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900 flex flex-col justify-between p-8 sm:p-12 lg:p-16 text-white">
        ...
        <div className="hidden lg:block">
          <h2 className="text-3xl font-extrabold leading-snug mb-4">Recuperar acesso</h2>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-gray-50 dark:bg-gray-950">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            <h1 className="text-2xl font-extrabold text-gray-900 dark:text-white">Esqueci minha senha</h1>
          ...
          {sent ? (
            <div className="space-y-4">
              <div className="text-sm text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl px-4 py-4">
                Se existir uma conta com este e-mail, você receberá um link para redefinir a senha em instantes.
                Verifique também a pasta de spam.
              </div>
              <Link
                href="/login"
                className="block w-full text-center py-3 bg-brand-500 hover:bg-brand-600 text-white font-bold rounded-xl text-sm transition-colors"
              >
                Voltar ao login
              </Link>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="w-full py-3 bg-brand-500 hover:bg-brand-600 disabled:opacity-60 text-white font-bold rounded-xl text-sm transition-colors"
              >
